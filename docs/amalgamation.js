...
(function(exports) {
  ...
  var values = function (v) {
      ...
      throw new Error("Failed pattern match at Data.Map line 554, column 1 - line 554, column 18: " + [ v.constructor.name ]);
  };
  ...
  var keys = function (v) {
      ...
      throw new Error("Failed pattern match at Data.Map line 548, column 1 - line 548, column 16: " + [ v.constructor.name ]);
  };
...
(function(exports) {
  ...
  var Codebug = function (codebug) {
      this.codebug = codebug;
  }; 
  var debugInt = new Debug(function (v) {
      return function (x) {
          return [ Halogen_HTML_Elements.code([  ])([ Halogen_HTML_Core.text(Data_Show.show(Data_Show.showInt)(x)) ]) ];
      };
  });
  var debug = function (dict) {
      return dict.debug;
  };
  var debugArray = function (dictDebug) {
      return new Debug(function (s) {
          return function (xs) {
              var cell = function (i) {
                  return function (x) {
                      return Halogen_HTML_Elements.td([  ])(debug(dictDebug)(s + ("." + Data_Show.show(Data_Show.showInt)(i)))(x));
                  };
              };
              return [ Halogen_HTML_Elements.table([  ])([ Halogen_HTML_Elements.tbody([  ])([ Halogen_HTML_Elements.tr([  ])(Data_Array.mapWithIndex(cell)(xs)) ]) ]) ];
          };
      });
  };
  var debugMaybe = function (dictDebug) {
      return new Debug(function (s) {
          return function (v) {
              if (v instanceof Data_Maybe.Nothing) {
                  return [ Halogen_HTML_Elements.fieldset([  ])([ Halogen_HTML_Elements.legend([  ])([ Halogen_HTML_Elements.code([  ])([ Halogen_HTML_Core.text("Nothing") ]) ]) ]) ];
              };
              if (v instanceof Data_Maybe.Just) {
                  return [ Halogen_HTML_Elements.fieldset([  ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)([  ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Halogen_HTML_Elements.legend([  ])([ Halogen_HTML_Elements.code([  ])([ Halogen_HTML_Core.text("Just") ]) ]) ])(debug(dictDebug)(s + ".fromJust")(v.value0)))) ];
              };
              throw new Error("Failed pattern match at Debug.GUI line 83, column 3 - line 84, column 69: " + [ s.constructor.name, v.constructor.name ]);
          };
      });
  }; 
  var codebugBoolean = new Codebug(function (v) {
      return function (x) {
          return [ Halogen_HTML_Elements.input([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.inputTypeIsProp)(DOM_HTML_Indexed_InputType.InputCheckbox.value), Halogen_HTML_Properties.checked(Data_Maybe.fromMaybe(false)(x)), Halogen_HTML_Events.onChecked(Halogen_HTML_Events.input(Data_Tuple.Tuple.create)) ]) ];
      };
  });
  var codebug = function (dict) {
      return dict.codebug;
  };
  var debugFunction = function (dictCodebug) {
      return function (dictDebug) {
          return new Debug(function (s) {
              return function (f) {
                  var renderOut = function (v) {
                      if (v instanceof Data_Maybe.Nothing) {
                          return [  ];
                      };
                      if (v instanceof Data_Maybe.Just) {
                          return debug(dictDebug)(s + ".output")(f(v.value0));
                      };
                      throw new Error("Failed pattern match at Debug.GUI line 132, column 5 - line 132, column 27: " + [ v.constructor.name ]);
                  };
                  var renderIn = codebug(dictCodebug)(s + ".input");
                  var render = function (x) {
                      return Halogen_HTML_Elements.div([  ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)([  ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)(renderIn(x))(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Halogen_HTML_Elements.hr([  ]) ])(renderOut(x)))));
                  };
                  var reject = Halogen_Component.unComponentSlot(function (p) {
                      return function (ctor) {
                          return function (input) {
                              return function (v) {
                                  return function (v1) {
                                      return function (v2) {
                                          return Halogen_Component.mkComponentSlot(p)(ctor)(input)(Data_Function["const"](Data_Maybe.Nothing.value))(Data_Function["const"](Data_Maybe.Nothing.value))(Data_Function["const"](Data_Maybe.Nothing.value));
                                      };
                                  };
                              };
                          };
                  ...
                  var $$eval = function (v) {
                      return Data_Functor.voidRight(Halogen_Query_HalogenM.functorHalogenM)(v.value1)(Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)(new Data_Maybe.Just(v.value0)));
                  };
                  var ui = Halogen_Component.parentComponent(Data_Ord.ordString)({
                      initialState: initialState, 
                      render: render, 
                      "eval": $$eval, 
                      receiver: Data_Function["const"](Data_Maybe.Nothing.value)
                  });
                  return [ Data_Bifunctor.lmap(Halogen_HTML_Core.bifunctorHTML)(reject)(Halogen_HTML.slot(s)(ui)(Data_Unit.unit)(Data_Void.absurd)) ];
              };
          });
      };
  };
  exports["Codebug"] = Codebug;
  exports["Debug"] = Debug;
  exports["codebug"] = codebug;
  exports["debug"] = debug;
  exports["codebugBoolean"] = codebugBoolean;
  exports["debugInt"] = debugInt;
  exports["debugArray"] = debugArray;
  exports["debugMaybe"] = debugMaybe;
  exports["debugFunction"] = debugFunction;
})(PS["Debug.GUI"] = PS["Debug.GUI"] || {});
(function(exports) {
  // Generated by purs version 0.11.5
  "use strict";
  var Control_Applicative = PS["Control.Applicative"];
...
(function(exports) {
  ...
  var Prelude = PS["Prelude"];        
  var ui = function (dictDebug) {
      var render = function ($12) {
          return Halogen_HTML_Elements.div([  ])(Debug_GUI.debug(dictDebug)("root")($12));
      };
      var receiver = function ($13) {
          return Data_Maybe.Just.create((function (v) {
              return new Data_Tuple.Tuple(v, Data_Unit.unit);
          })($13));
      };
      var initialState = Control_Category.id(Control_Category.categoryFn);
      var $$eval = function (v) {
          return Data_Functor.voidRight(Halogen_Query_HalogenM.functorHalogenM)(v.value1)(Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)(v.value0));
      };
  ...
  var main = (function () {
      var value = [ new Data_Maybe.Just(function (v) {
          if (v) {
              return 0;
          };
          return 1;
      }), new Data_Maybe.Just(function (v) {
          if (v) {
              return 1;
          };
          return 2;
      ...
      return Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Control_Monad_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(Halogen_VDom_Driver.runUI(ui(Debug_GUI.debugArray(Debug_GUI.debugMaybe(Debug_GUI.debugFunction(Debug_GUI.codebugBoolean)(Debug_GUI.debugInt)))))(value)));
  })();
  exports["main"] = main;
})(PS["Main"] = PS["Main"] || {});
PS["Main"].main();
